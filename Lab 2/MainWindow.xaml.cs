...
namespace Lab_2
{
    class BankAccount
    {
        ...
        public void Withdraw(double amount)
        {
            ...
            var file = @"D:\Lab 2.ver3\" + AccountNumber + "_balance.txt";
            var fileH = @"D:\Lab 2.ver3\" + AccountNumber + "_history.txt";
        ...
        {
            using (FileStream fs = File.Create(@"D:\Lab 2.ver3\" + number + "_history.txt")) { }
            using (FileStream fs = File.Create(@"D:\Lab 2.ver3\" + number + "_balance.txt")) { }
            using (StreamWriter sw = new StreamWriter(@"D:\Lab 2.ver3\" + number + "_balance.txt")) { sw.WriteLine(0); }
        }
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            var file = @"D:\Lab 2.ver3\" + _NameOfAccount + "_history.txt"; 
            var file1 = @"D:\Lab 2.ver3\" + _NameOfAccount + "_balance.txt";
           ...
           double balance = 0;
            ...
            BankAccount bank = new BankAccount(_NameOfAccount, balance);
            bank.Deposit(value);
        ...
        public void Button_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            {
                ShowAll(file);
                LabelNumber.Content = _NameOfAccount;
        ...
        {   _NameOfAccount = TB.Text; 
            ...
            BankAccount.NewAccount(_NameOfAccount); 
            using (StreamReader sr = new StreamReader(file1)) { balance = Convert.ToDouble(File.ReadAllText(file1)); }
            ShowAll(file);
            LabelNumber.Content = _NameOfAccount;
